# `lazygit_jll.jl` (v0.61.1+0)

[![deps](https://juliahub.com/docs/lazygit_jll/deps.svg)](https://juliahub.com/ui/Packages/General/lazygit_jll/)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/ba2bf3a594b8f839a2784af5e4f648ec45e23b10/L/lazygit/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
The tarballs for `lazygit_jll.jl` have been built from these sources:

* git repository: https://github.com/jesseduffield/lazygit.git (revision: `d167063b4f45d044524f3fba97f850d1eec3f95c`)

## Platforms

`lazygit_jll.jl` is available for the following platforms:
